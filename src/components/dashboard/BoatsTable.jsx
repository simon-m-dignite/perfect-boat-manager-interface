...
const BoatsTable = () => {
  ...
  return (
    <div className="w-full h-auto flex flex-col gap-3 p-4 lg:p-6 rounded-[18px] bg-[#001229]">
      ...
      <div className="w-full h-auto flex justify-between items-center">
        <div className="flex w-1/2 lg:w-[295px] h-[35px]  justify-start items-start rounded-[8px] bg-[#1A293D] relative">
